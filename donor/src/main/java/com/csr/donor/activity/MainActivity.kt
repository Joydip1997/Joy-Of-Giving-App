...
import com.csr.donor.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun isAtBottomNavFragments(id : Int): Boolean {
        val bottomNavFragments = listOf(R.id.homeFragment,R.id.ratesFragment,R.id.pickupFragment,R.id.orderFragment,R.id.profileFragment)
